...
> [!TIP]
> Models of argument such as the [Argument Interchange Format (AIF)](https://en.wikipedia.org/wiki/Argument_Interchange_Format) can be of use for representing arguments in MIME messages.
> 
> <details>
