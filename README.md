...
[Knowledge graphs](https://en.wikipedia.org/wiki/Knowledge_graph) can also be of use in MIME messages to provide [metadata](https://en.wikipedia.org/wiki/Metadata) about other parts in the messages.
