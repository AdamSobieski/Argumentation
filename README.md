...
As HTML content in MIME messages can use RFC 2392, the `cid:` URL scheme, to enable inline images in email messages, in theory HTML content could use this URL scheme in [data blocks](https://html.spec.whatwg.org/multipage/scripting.html#data-block) in a manner resembling: `<script id="argument1" type="application/argument+xml" src="cid:part1" />`.
