...
Artificial-intelligence tools could categorize messages for purposes of routing them to interested end-users. [Embedding vectors](https://en.wikipedia.org/wiki/Embedding_(machine_learning)) could be of use for messages' classes, or topics.
