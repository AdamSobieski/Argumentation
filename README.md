...
Several of these artificial-intelligence API message models include support for content to be either a string or an array or otherwise to accept one or more content parts, e.g., text accompanied by image data.
